...
export const AppList: {
  ...
  contacts: { name: 'Contacts', ctx: 'contacts', load: 'None' },
  cut: { name: 'Cut the Rope', ctx: 'books', load: 'None' },
  dictionary: { name: 'Dictionary', ctx: 'books', load: 'None' },
  ...
  finder: { name: 'Finder', ctx: 'finder', load: 'None' },
  ...
  launchpad: { name: 'Launchpad', ctx: 'launchpad', load: 'None' },
  logic: { name: 'Logic Pro', ctx: 'logic', load: 'None' },
  mail: { name: 'Mail', ctx: 'mail', load: 'None' },
  maps: { name: 'Maps', ctx: 'maps', load: 'None' },
//   messages: { name: 'Messages', ctx: 'messages', load: 'None' },
  monitor: { name: 'Monitor', ctx: 'monitor', load: 'None' },
  music: { name: 'Music', ctx: 'music', load: 'None' },
  news: { name: 'News', ctx: 'Notes', load: 'None' },
  notes: { name: 'Notes', ctx: 'notes', load: 'None' },
